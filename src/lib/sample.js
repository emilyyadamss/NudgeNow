...
const GOALS = [
  { name: 'Japanese', emoji: 'message', colorSlot: 1, unitId: 'hours',    cadence: 'week',  target: 5,
    category: 'Learning',
  ...
  { name: 'Side projects', emoji: 'laptop', colorSlot: 2, unitId: 'hours', cadence: 'week', target: 8,
    category: 'Creative',
    why: 'Ship something small every month.',            density: 0.42, size: [1, 3] },
  { name: 'Reading', emoji: 'book', colorSlot: 3, unitId: 'pages',      cadence: 'week',  target: 150,
    category: 'Learning',
    why: 'Two books a month.',                           density: 0.60, size: [10, 45],
    tasks: [['Finish part two of the current book', 80], ['Return library books', 0]] },
  { name: 'Running', emoji: 'run', colorSlot: 4, unitId: 'km',         cadence: 'week',  target: 20,
    category: 'Health',
    why: 'Half marathon in the spring.',                 density: 0.34, size: [3, 9] },
  { name: 'Piano', emoji: 'piano', colorSlot: 5, unitId: 'minutes',      cadence: 'week',  target: 150,
    category: 'Creative',
  ...
  { name: 'Touch typing', emoji: 'keyboard', colorSlot: 6, unitId: 'sessions', cadence: 'week', target: 3,
    category: 'Learning',
    why: 'Stop looking at the keyboard.',                density: 0.5,  size: [1, 2],
    status: STATUS.REVISIT, revisitEvery: 30, finishedDaysAgo: 47 },
  { name: 'Driving lessons', emoji: 'car', colorSlot: 7, unitId: 'lessons', cadence: 'week', target: 2,
    category: 'Personal',
